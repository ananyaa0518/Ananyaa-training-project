...
function PrivacyPolicy() {
  return (
    <>
      <section className="relative min-h-[420px] overflow-hidden bg-[#1A3A5C]">
        ...
        <div className="relative z-10 flex min-h-[420px] items-center justify-center px-8 text-center">
          <div>
            <h1 className="text-[64px] font-bold text-white">
              Privacy &<span className="text-[#F4D6A6]"> Policy</span>
            </h1>
          </div>
        </div>
      </section>
      <section className="bg-[#F8F8F8] py-20">
        <div className="mx-auto max-w-[1100px] px-8 text-[#6B7280]">
