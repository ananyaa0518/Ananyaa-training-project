...
function Contact() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative min-h-[520px] overflow-hidden bg-[#163B69]">
        ...
        <div className="relative z-10 flex min-h-[520px] items-center justify-center px-8 text-center">
          <div>
      ...
      <section className="bg-[#F5EFE2] py-24">
        <div className="mx-auto max-w-[1440px] px-8">
          <div className="grid gap-12 lg:grid-cols-[720px_420px] lg:justify-center">
            {/* Form */}
            <div className="rounded-[24px] bg-white p-12 shadow-sm">
              <h2 className="mb-3 text-[36px] font-bold text-[#3B3F4A]">
                How can we help you?
              </h2>

              <p className="mb-10 text-[15px] leading-7 text-[#8A8A8A]">
              ...
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    className="h-[56px] w-full rounded-lg border border-[#D8D8D8] px-4 outline-none"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-lg border border-[#D8D8D8] px-4 py-4 outline-none"
                  />
                </div>

                <button
                  type="submit"
                  className="h-[56px] w-full rounded-lg bg-[#F4A300] font-semibold text-white transition hover:bg-[#E59A00]"
                >
                  Submit
                </button>
              </form>
      ...
      <section className="bg-[#F8F8F8] py-24">
        <div className="mx-auto max-w-[1100px] px-8">
          <h2 className="mb-12 text-center text-[40px] font-bold text-[#2F3540]">
            Frequently Asked Questions
          </h2>

          <div className="space-y-4">
            <div className="rounded-xl border border-[#F4E2C0] bg-[#FFF8EC] px-8 py-6">
            ...
            <div className="rounded-xl border border-[#E5E5E5] bg-white px-8 py-5">
