...
function Login() {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen overflow-y-auto md:overflow-hidden md:h-screen">
      <div className="flex w-full md:w-1/2 flex-col justify-between bg-[#163B69] px-8 py-12 md:px-16 text-white">
        <div>
        ...
        <p className="text-xs text-gray-300 mt-8 md:mt-0">
          © 2026 SEEN Pty Ltd · jrpos.app · support@jrpos.app
        </p>
      </div>

      <div className="flex w-full md:w-1/2 items-center justify-center bg-[#F8F8F8] px-8 py-12 md:px-16">
        <div className="w-full max-w-lg">
          <h1 className="text-4xl md:text-5xl font-bold text-black">Login</h1>
